...
cmd = 'combineTool.py -M Asymptotic monojet_scalar.txt -t -1 --setParameters lumiScale=10 --freezeParameters lumiScale --cl=0.95 --rMin=-5 --rMax=5 -m %s --job-mode lxbatch --task-name "Moriond" -n CENTRAL --sub-opts "-q 1nh " --merge 2 '%(stri)
